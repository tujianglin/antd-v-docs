...
<demo vue="descriptions/basic.vue"></demo>

### 带边框的

<demo vue="descriptions/border.vue"></demo>

### 自定义尺寸

<demo vue="descriptions/size.vue"></demo>

### 响应式

<demo vue="descriptions/responsive.vue"></demo>

### 垂直

<demo vue="descriptions/vertical.vue"></demo>

### 垂直带边框的

<demo vue="descriptions/vertical-border.vue"></demo>

### 整行

<demo vue="descriptions/block.vue"></demo>
...
| span | 包含列的数量（`filled` 铺满当前行剩余部分） | number\| `filled` \| [Screens](/components/grid) | 1 | `screens: 5.9.0`，`filled: 5.22.0` |
