...
<demo vue="tour/basic.vue"></demo>

### 非模态

<demo vue="tour/non-modal.vue"></demo>

### 位置

<demo vue="tour/placement.vue"></demo>

### 自定义遮罩样式

<demo vue="tour/mask.vue"></demo>

### 自定义指示器

<demo vue="tour/indicator.vue"></demo>

### 自定义操作按钮

<demo vue="tour/actions-render.vue" version="5.25.0"></demo>

### 自定义高亮区域的样式

<demo vue="tour/gap.vue"></demo>
...
| closeIcon | 自定义关闭按钮 | `VNode` | `true` | 5.9.0 |
